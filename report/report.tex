...
This project has effectively demonstrated the use of YOLOv11 for food item image detection and calorie and allergen estimation.
In this project, we have combined transfer learning with Allergen30 dataset to build a model that classifies food items and predicts the calories and allergen of a food image.
