...
The focus is to leverage YOLOv11\cite{redmon2016lookonceunifiedrealtime}, an object detection model recognized for speed and accuracy, to identify food items from images and provide a swift estimation of their calorific content while engaging in a check for allergen information. 
