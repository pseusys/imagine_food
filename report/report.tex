...
In this project, we focus on nutrition, but the technique can be also used in other parts of our daily life, for example: Healthcare (assist in medical image analysis), Shopping assistants (advising while online shopping), Pet monitoring (alert if the pet is performing unusual activity). 
